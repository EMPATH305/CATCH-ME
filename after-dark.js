...
try{
  if(typeof labels!=='undefined') Object.assign(labels,{
    consent:['THE SAFE YES','你在意的不只是靠近，而是雙方都能清楚地說要、不要、等一下。真正的安全感來自選擇一直都在。'],
    desire:['THE WANT SIGNAL','你不排斥慾望本身；真正有重量的是，那份想靠近是清醒、明確，而且彼此都有份。'],
    initiation:['THE FIRST MOVE','你願意主動往前，但主動對你不是接管，而是一邊靠近、一邊確認對方也在往你這邊走。']
  });
  if(typeof quotes!=='undefined') Object.assign(quotes,{
    consent:'「真正性感的是：我隨時都能說不，而你真的會聽。」',
    desire:'「我可以很想靠近，但我不要失去判斷力。」',
    initiation:'「我可以先走一步，但我要看見你也在靠近。」'
  });
