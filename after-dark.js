...
const questions=[
{text:'氣氛已經很明顯了，但沒有人先往前。你比較可能？',opts:['先不動，看看對方會不會給更明確的訊號','我先靠近一點，看對方會不會接','直接問：「我可以親你嗎？」','繼續聊天，讓張力自己燒','我有自己的版本'],traits:{A:['desire','tension'],B:['initiation','reciprocity'],C:['consent','direct'],D:['tension'],E:['boundary']}},
{text:'真正讓你感覺到「我們都想靠近」的是？',opts:['有人很明確地把想法說出來','眼神跟距離已經很有答案','其中一個先靠近，但會讀對方的反應','平常都克制，只有彼此之間明顯不一樣','這題沒有我的弱點'],traits:{A:['clarity','desire'],B:['sensory','tension'],C:['consent','reciprocity'],D:['exclusivity','contrast'],E:['desire']}},
{text:'親密互動裡，你比較喜歡節奏怎麼形成？',opts:['對方主導多一點，我比較能放鬆','我主導多一點，我喜歡掌握節奏','輪流，誰有感覺誰就接手','完全看當下，不要固定角色','我的答案比較複雜'],traits:{A:['trust','soft'],B:['confidence','direct'],C:['reciprocity','balance'],D:['freedom','tension'],E:['balance']}},
{text:'對方突然停下來問：「這樣可以嗎？」',opts:['超加分，安全感直接上升','可以，但不用每一步都問到像填表格','我會直接告訴對方我想要什麼','氣氛可能斷一下，但我還是覺得該問','看關係跟當下，我自己說'],traits:{A:['consent','trust'],B:['tension','trust'],C:['direct','confidence'],D:['consent','boundary'],E:['boundary']}},
...
{text:'如果你今天完全沒有心情，但對方很想靠近？',opts:['直接說今天不行，不需要愧疚','先抱抱，但清楚說界線在哪','會怕掃興，所以可能先配合一點','看對方怎麼問；被尊重反而可能讓我放鬆','我要自己回答'],traits:{A:['boundary','direct'],B:['boundary','soft'],C:['soft'],D:['consent','trust'],E:['boundary']}},
{text:'哪個細節最容易讓你的理性短暫下線？',opts:['說話的聲音／語氣突然變得很有張力','靠近時的氣味或距離感','對方做某件事時突然超專注、很有掌控感','一個很明確、沒有移開的眼神','研究員不要蒐集弱點🙂'],traits:{A:['sensory'],B:['sensory','desire'],C:['competence','sensory'],D:['tension','desire'],E:['freedom']}},
...
{text:'你最不喜歡哪種「親密」？',opts:['把我的拒絕當欲擒故縱','什麼都不講，期待我自己猜','只顧自己，不讀我的反應','用親密來證明我愛不愛對方','全部，謝謝。'],traits:{A:['consent','boundary'],B:['clarity','direct'],C:['reciprocity','trust'],D:['boundary','trust'],E:['boundary','consent']}},
...
{text:'什麼會讓你在親密裡真正放鬆？',opts:['知道我隨時可以說停，而且不會被不爽','很確定對方只是在乎我，不是在表現自己','我們可以笑、可以失誤，不用演得很完美','我知道對方懂我的反應，不用每次解釋','都重要，我不接受砍選項'],traits:{A:['consent','trust'],B:['trust','reciprocity'],C:['play','soft'],D:['depth','trust'],E:['balance']}},
