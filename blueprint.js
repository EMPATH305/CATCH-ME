...
function mount(){const grid=document.querySelector('.blueprint-grid');if(!grid||document.querySelector('.blueprint-v2'))return;grid.insertAdjacentHTML('beforeend','<section class="blueprint-v2"><div class="blueprint-v2-head"><div><p class="card-label">BLUEPRINT 2.0</p><h3>YOUR RELATIONSHIP<br>TENSIONS</h3></div><p>不是人格百分比。這些軸只描述你目前答案裡反覆出現的拉扯。</p></div><div id="tensionList" class="tension-list"></div><p class="blueprint-disclaimer">CATCH ME 是互動式自我探索遊戲，不是心理診斷。結果會隨你完成更多章節而更新。</p></section>');render()}
